...
const controller     = require('../controllers/estilista.controller');
...
router.get('/:id/horarios',       checkRoles('super_admin', 'admin_sucursal', 'estilista'), controller.obtenerHorarios);
router.put('/:id/horarios',       checkRoles('super_admin', 'admin_sucursal'),            controller.reemplazarHorarios);
